        ...
        bmak = bmak || {
            ...
            mn_poll: function () {
                if (0 == bmak.mn_state) {
                    ...
                    null != a && (bmak.mn_update_challenge_details(a), sensorPromiseResolve && sensorPromiseResolve(), bmak.mn_sen && (bmak.mn_state = 1, bmak.mn_mc_indx = 0, bmak.mn_al = [], bmak.mn_il = [], bmak.mn_tcl = [], bmak.mn_lg = [], setTimeout(bmak.mn_w, 0)))
                }
            },
