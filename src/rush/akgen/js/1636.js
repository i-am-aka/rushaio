export default function(window, document, navigator, screen, Date, sensorPromiseResolve, setTimeout, setInterval, clearTimeout, clearInterval) {
    var _sd_trace= '';
    var _cf = _cf || []; _cf.push(['_setFsp', true]);  _cf.push(['_setBm', true]);  _cf.push(['_setAu', '/static/11b1083932ati181847036ca577da34d9']);
    var bmak = window.bmak = {
        ver: 1.66,
        ke_cnt_lmt: 150,
        mme_cnt_lmt: 100,
        mduce_cnt_lmt: 75,
        ...
        //         bmak.wv = 'n', bmak.wr = 'n', bmak.weh = 'n', bmak.wl = 0, t && (bmak.wv = 'b', bmak.wr = 'b', bmak.weh = 'b', t.getSupportedExtensions() && (bmak.weh = bmak.ats(bmak.mn_s(JSON.stringify(t.getSupportedExtensions().sort()))), bmak.wl = t.getSupportedExtensions().length, t.getSupportedExtensions().indexOf('WEBGL_debug_renderer_info') >= 0 && (bmak.wv = t.getParameter(t.getExtension('WEBGL_debug_renderer_info').UNMASKED_VENDOR_WEBGL), bmak.wr = t.getParameter(t.getExtension('WEBGL_debug_renderer_info').UNMASKED_RENDERER_WEBGL))))
        //     } catch (a) {
        ...
        apicall_bm: function (a, t, e) {
            // console.trace();
            // console.log('apicall_bm', bmak.sensor_data);
            console.log(bmak.mn_get_current_challenges().length, bmak.aj_type, bmak.aj_indx)
            if ((bmak.firstLoad && bmak.mn_get_current_challenges().length === 0) || bmak.aj_type === 8) {
                sensorPromiseResolve(bmak.sensor_data);
            }
            return;
            console.trace();
            var n;
